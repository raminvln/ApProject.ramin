...
public class AdminTest {
    ...
    public void changeUserNamePassword() {
        admin.changePassword(ali, "azinbebaaD3437");
        admin.changePassword(taghi, "null)::PE34");
        assertEquals("azinbebaaD3437", ali.getPassword());
        assertEquals("null)::PE34", taghi.getPassword());
        admin.changeUserName(ali, "modifiedAliAlavi");
        admin.changePassword(taghi,"modifiedTaghiTaghavi");
    }
