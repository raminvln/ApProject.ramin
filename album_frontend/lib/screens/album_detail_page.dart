...
class _AlbumDetailPageState extends State<AlbumDetailPage> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color:
                      _getColorForAlbum(widget.album).withValues(alpha: 0.3),
                  blurRadius: 12,
            ...
            child: Row(
              ...
              children: [
                ...
                _buildInfoItem(
                    Icons.update, 'Updated', _getLastUpdated()),
                Container(
                  width: 1,
                  height: 40,
                  color: Colors.white.withValues(alpha: 0.3),
                ),
                _buildInfoItem(Icons.photo_library, 'Photos',
  ...
  Widget _buildDateSection(
      String dateLabel, List<PhotoModel> photos, bool isDark) {
    final textColor = isDark ? Colors.white : const Color(0xFF111827);
